function checkCode() {
    ...
    const displayMessage = document.getElementById('display-download')
    ...
    profile.innerText = "Missing: The Other Side"
    episodes.innerHTML = '<b>Episodes:</b> 12'
    downloadButton.setAttribute('href', "https://tinyurl.com/Missing-The-Other-Side-TG")
}
